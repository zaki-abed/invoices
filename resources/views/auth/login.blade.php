            ...
            <div class="col-md-6 col-lg-6 col-xl-5 bg-white">
                <div class="login d-flex align-items-center py-2">
                    ...
                    <div class="container p-0">
                        <div class="alert alert-success" role="alert" style="direction: ltr; text-align: left;">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close" style="float: right">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            <h4 class="alert-heading">Hi!</h4>
                            <div>
                                <p>This project for demo, you can test it with:</p>
                                <p>Admin Account</p>
                                <ul>
            ...
            <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
                <div class="row wd-100p mx-auto text-center">
                    <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
                        <img src="http://accessline.ps/Image/fe24d309-8b65-46dd-815d-394f7dd9d670.png"
