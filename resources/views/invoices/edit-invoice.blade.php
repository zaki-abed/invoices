...
@section('content')
    ...
    @if (session()->has('add_invoice'))
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>{{ session()->get('add_invoice') }}</strong>
    ...
    <div class="row">
        ...
        <div class="alert alert-success" role="alert">
            ...
            <strong>{{ session('update_invoice') }}</strong>
        </div>
        @endif
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="section_id" class="form-control SlectBox"
                                    id="section_id"
                                    onclick="console.log($item->id.val())"
                                    {{-- onload="console.log('dsads')" --}}
                                    onchange="console.log('change is firing')">
                                    @foreach ($sections as $item)
                                        <option value="{{ $item->id }}" {{ $item->id == $invoice->section->id ? 'selected' : ''}}> {{ $item->section_name }}</option>
                                    @endforeach
                                </select>
                            </div>
...
@section('js')
    ...
    <script>
        ...
        // let id = document.getElementById("section_id").id;

        // console.log('dadsdsda ' + id)
    </script>
