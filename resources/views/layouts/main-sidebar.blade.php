...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . $page='home') }}"><img src="http://accessline.ps/Content/assets2/svg/accessline-logo.svg" class="main-logo" alt="logo"></a>
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('partially-paid-invoices') }}">الفواتير المدفوعة جزئيا</a></li>
                    @endcan
                    @can('ارشيف الفواتير')
                    <li><a class="slide-item" href="{{ route('invoices-archives') }}">أرشيف الفواتير</a></li>
                    @endcan
                </ul>
            </li>
            @endcan
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    @can('تقرير الفواتير')
                    <li><a class="slide-item" href="{{ route('reports-invoices') }}">تقارير الفواتير</a></li>
                    @endcan
                    @can('تقرير العملاء')
                    <li><a class="slide-item" href="{{ route('report-customer') }}">تقارير العملاء</a></li>
                    @endcan
                </ul>
            </li>
            @endcan
