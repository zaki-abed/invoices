                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{route('make-all-read')}}">تعيين الكل كمقروء</a></span>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12" id="notificationCount">لديك
                                {{ auth()->user()->unreadNotifications->count() }} إشعارات غير مقروءة</p>
                        </div>

                        <div class="main-notification-list Notification-scroll" id="unreadNotifications">
                            @if (auth()->user()->unreadNotifications)
                                @foreach (auth()->user()->unreadNotifications as $notification)
                                    <a class="d-flex p-3 border-bottom" href="{{route('invoice-details', $notification->data['id'])}}">
                                        ...
                                        <div class="mr-3">
                                            ...
                                            <div class="notification-subtext">منذ {{ $notification->data['user'] }}
                                            </div>
                                        </div>
