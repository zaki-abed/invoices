            ...
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    @csrf
                        <div class="row mb-4">
                            <div class="col-lg-3">
                                <label class="rdiobox" for="type_div">
                                    <input checked name="radio" type="radio" value="1" id="type_div"><span>بحث بنوع الفاتورة</span>
                                </label>
                            </div>
                            <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                <label class="rdiobox" for="type-number">
                                    <input name="radio" value="2" type="radio" id="type-number"><span>بحث برقم الفاتورة</span>
                                </label>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                                ...
                                <select class="form-control select2" name="type" required>
                                    ...
                                    <option value="مدفوعة كاملة">الفواتير المدفوعة</option>
                                    <option value="غير مدفوعة">الفواتير الغير مدفوعة</option>
                                    <option value="مدفوعة جزئياً">الفواتير المدفوعة جزئيا</option>
                                </select>
                            </div>
